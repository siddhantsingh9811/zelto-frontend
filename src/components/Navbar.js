                ...
                <Link to="/" style={{ color: 'inherit', textDecoration: 'inherit'}}>
                    <li className='active' onClick={handleClick}>
                        <svg preserveAspectRatio="true" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M10.07 2.82L3.13999 8.37C2.35999 8.99 1.85999 10.3 2.02999 11.28L3.35999 19.24C3.59999 20.66 4.95999 21.81 6.39999 21.81H17.6C19.03 21.81 20.4 20.65 20.64 19.24L21.97 11.28C22.13 10.3 21.63 8.99 20.86 8.37L13.93 2.83C12.86 1.97 11.13 1.97 10.07 2.82Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                ...
                <Link to="/profile" style={{ color: 'inherit', textDecoration: 'inherit'}}>
                    <li onClick={handleClick}>
                        <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12.66 10.87C12.56 10.86 12.44 10.86 12.33 10.87C9.95 10.79 8.06 8.84 8.06 6.44C8.06 3.99 10.04 2 12.5 2C14.95 2 16.94 3.99 16.94 6.44C16.93 8.84 15.04 10.79 12.66 10.87Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M7.65997 14.56C5.23997 16.18 5.23997 18.82 7.65997 20.43C10.41 22.27 14.92 22.27 17.67 20.43C20.09 18.81 20.09 16.17 17.67 14.56C14.93 12.73 10.42 12.73 7.65997 14.56Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
