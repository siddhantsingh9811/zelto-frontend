    ...
    return (
        <div className="home">
            <div className="location">
                ...
                <div className="cur" onClick={() => setShowLocationDropdown(!showLocationDropdown)}>
                    <svg className="l" preserveAspectRatio="true" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg className="a" preserveAspectRatio="true" viewBox="0 0 14 9" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => setShowLocationDropdown(!showLocationDropdown)}>
                ...
                <div className="search">
                    ...
                    <div className="f-button" onClick={() => setShowSortingOptions(!showSortingOptions)}>
                        <svg className="f" preserveAspectRatio="true" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M16.9675 7.56249C17.4258 7.56249 17.7925 7.19583 17.7925 6.73749V2.47499C17.7925 2.01666 17.4258 1.64999 16.9675 1.64999C16.5092 1.64999 16.1425 2.01666 16.1425 2.47499V6.73749C16.1425 7.18666 16.5183 7.56249 16.9675 7.56249Z" fill="#1A1E25"/>
                            <path d="M11 14.4375C10.5417 14.4375 10.175 14.8042 10.175 15.2625V19.525C10.175 19.9833 10.5417 20.35 11 20.35C11.4583 20.35 11.825 19.9833 11.825 19.525V15.2625C11.825 14.8133 11.4583 14.4375 11 14.4375Z" fill="#1A1E25"/>
                            <path d="M5.03252 7.56249C5.49085 7.56249 5.85752 7.19583 5.85752 6.73749V2.47499C5.85752 2.01666 5.49085 1.64999 5.03252 1.64999C4.57419 1.64999 4.20752 2.01666 4.20752 2.47499V6.73749C4.20752 7.18666 4.57419 7.56249 5.03252 7.56249Z" fill="#1A1E25"/>
                            <path d="M6.7375 9.32251H3.3275C2.86917 9.32251 2.5025 9.68918 2.5025 10.1475C2.5025 10.6058 2.86917 10.9725 3.3275 10.9725H4.2075V19.525C4.2075 19.9833 4.57417 20.35 5.0325 20.35C5.49083 20.35 5.8575 19.9833 5.8575 19.525V10.9725H6.7375C7.19583 10.9725 7.5625 10.6058 7.5625 10.1475C7.5625 9.68918 7.18667 9.32251 6.7375 9.32251Z" fill="#1A1E25"/>
                            <path d="M18.6725 9.32251H15.2625C14.8042 9.32251 14.4375 9.68918 14.4375 10.1475C14.4375 10.6058 14.8042 10.9725 15.2625 10.9725H16.1425V19.525C16.1425 19.9833 16.5092 20.35 16.9675 20.35C17.4258 20.35 17.7925 19.9833 17.7925 19.525V10.9725H18.6725C19.1308 10.9725 19.4975 10.6058 19.4975 10.1475C19.4975 9.68918 19.1308 9.32251 18.6725 9.32251Z" fill="#1A1E25"/>
                            <path d="M12.705 11.0275H11.825V2.47499C11.825 2.01666 11.4583 1.64999 11 1.64999C10.5416 1.64999 10.175 2.01666 10.175 2.47499V11.0275H9.29497C8.83664 11.0275 8.46997 11.3942 8.46997 11.8525C8.46997 12.3108 8.83664 12.6775 9.29497 12.6775H12.705C13.1633 12.6775 13.53 12.3108 13.53 11.8525C13.53 11.3942 13.1633 11.0275 12.705 11.0275Z" fill="#1A1E25"/>
                        </svg>
                    </div>
                </div>
            </div>
