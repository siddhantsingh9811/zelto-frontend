  ...
  useEffect(() => {
    ...
    return ( 
        ...
        transition={{ duration: 0.4, ease: "easeInOut", delay: 0.3 }}>
            <h2 className="t">Active Bookings</h2>
          ...
          <div className="cart-item" key={item._id}>
            ...
            <h2 className="t">Previous Bookings</h2>
            <div className="cart-items greyed">
             {cartItems.map((item) => (
          <div className="cart-item" key={item._id}>
            <img
              src="https://bd.gaadicdn.com/processedimages/tvs/tvs-scooty-zest/494X300/tvs-scooty-zest6476deb7d6ae9.jpg"
